...
const HowItWorks = () => {
  return <section id="how-it-works" className="py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-montserrat font-bold text-wizpen-primary mb-4">How WizStudio Works</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">Launch and sell your content in minutes with our streamlined process. No fee % required when withdrawal, no complex setup — just pure creation and monetization.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => <div key={index} className="relative">
              ...
              {/* Connector line */}
              {index < steps.length - 1 && <div className="hidden lg:block absolute top-10 right-0 w-full h-0.5 bg-gray-200 transform translate-x-1/2 z-0">
