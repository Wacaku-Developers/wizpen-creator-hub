...
const Footer = () => {
  return (
    <footer className="bg-wizpen-primary text-white">
      <div className="max-w-7xl mx-auto py-16 px-6 md:px-12 lg:px-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/80 mb-6 max-w-sm">
              The all-in-one platform for creators to create, sell, and manage digital content with full control.
            </p>
          ...
          <div>
            <h3 className="font-montserrat font-semibold text-lg mb-4">Product</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Creator Guides</a></li>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <div className="text-white/60 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Wizpen Studio. All rights reserved.
          </div>
